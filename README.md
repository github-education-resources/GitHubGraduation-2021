...
Replace `alexacosta1699` with your GitHub username in this guide.

### First, create the folder _data/alexacosta1699/ 
Fork this repository, create a new folder inside the `_data` folder, and name it with your username. It should look something like this `_data/alexacosta1699/`. Ex.

```
_data/alexacosta1699/
```
### Second, add your profile information
Create a markdown file in your folder following the convention `alexacosta1699.md`. Ex.

```
_data/alexacosta1699/alexacosta1699.md
```
