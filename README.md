...
Replace `JarrelThomas` with your GitHub username in this guide.

### First, create the folder _data/JarrelThomas/ 
Fork this repository, create a new folder inside the `_data` folder, and name it with your username. It should look something like this `_data/JarrelThomas`. Ex.

```
_data/JarrelThomas/
```
### Second, add your profile information
Create a markdown file in your folder following the convention `<JarrelThomas>.md`. Ex.

```
_data/JarrelThomas/JarrelThomas.md
```
