...
Replace `danielj0nes` with your GitHub username in this guide.

### First, create the folder _data/danielj0nes/ 
Fork this repository, create a new folder inside the `_data` folder, and name it with your username. It should look something like this `_data/danielj0nes/`. Ex.

```
_data/danielj0nes/
```
### Second, add your profile information
Create a markdown file in your folder following the convention `<danielj0nes>.md`. Ex.

```
_data/danielj0nes/danielj0nes.md
```
