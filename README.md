...
Replace `<joemccall86>` with your GitHub username in this guide.

### First, create the folder _data/joemccall86/ 
Fork this repository, create a new folder inside the `_data` folder, and name it with your username. It should look something like this `_data/<joemccall86>/`. Ex.

```
_data/MonaTheOctocat/
```
### Second, add your profile information
Create a markdown file in your folder following the convention `<joemccall86>.md`. Ex.
